 ...
 * Plugin URI: http://buddyuser.com/plugin-bp-featured-groups/
 * Author: Venutius
...
class BP_Featured_Groups {
	...
	public function load_assets() {
		...
		wp_register_script( 'bp-featured-groups', $this->url . 'assets/js/bp-featured-groups.js', array( 'jquery' ) );
	...
	public function load_admin_assets() {
		wp_register_script( 'bp-featured-groups-admin', $this->url . 'assets/js/bp-featured-groups-admin.js', array( 'jquery' ) );
