...
class BP_Featured_Groups_List_Widget extends WP_Widget {
	...
	public function __construct( $name = '', $widget_options = array() ) {
		...
		if ( empty( $name ) ) {
			$name = __( 'BuddyPress Featured Groups', 'bp-featured-groups' );
		}
	...
	public function form( $instance ) {
		...
		$defaults = array(
			'title'              => __( 'Featured Groups', 'bp-featured-groups' ),
			'max'                => 5,
			'avatar_size'        => '',
			'view'               => 'list',
			'group_type'        => '',
		...
		<p>
			<label>
				<?php _e( 'Title:', 'bp-featured-groups' ); ?><br/>
		...
		<p>
			<label>
				<?php _e( 'Max. number of groups to show:', 'bp-featured-groups' ); ?>
        ...
        <p>
            <label>
				<?php _e( 'Avatar size:', 'bp-featured-groups' ); ?>
        ...
        <?php if ( ! empty( $group_types ) ) : ?>
            <p>
                <label>
					<?php _e( 'Filter by Group Type', 'bp-featured-groups' ); ?>
                    <select id="<?php echo $this->get_field_id( 'group_type' ); ?>" name ="<?php echo $this->get_field_name( 'group_type' ); ?>">
                        <option value="" <?php selected( $group_type, "" ); ?> ><?php _e( 'N/A', 'bp-featured-groups' );?> </option>
        ...
        <p>
			<label>
				<?php _e( 'Display View:', 'bp-featured-groups' ); ?>
				<select class="bpfg-widget-admin-widget-view-options" id="<?php echo $this->get_field_id( 'view' ); ?>" name="<?php echo $this->get_field_name( 'view' ); ?>">
        ...
        <div class="bpfg-widget-admin-widget-slide-options" style="display:<?php echo $display_style;?>;">
            <h3><?php _e( 'Slide Options', 'bp-featured-groups' );?></h3>
        <p>
            <label>
				<?php _e( 'Slide items:', 'bp-featured-groups' ); ?>
        ...
        <p>
            <label>
				<?php _e( 'Slide margin:', 'bp-featured-groups' ); ?>
        ...
        <p>
            <label>
				<?php _e( 'Slide mode', 'bp-featured-groups' ); ?>
                <select id="<?php echo $this->get_field_id( 'slide_mode' ); ?>" name="<?php echo $this->get_field_name( 'slide_mode' ); ?>">
                    <option value="slide" <?php selected( $slide_mode, 'slide' )?>><?php _e( 'Slide', 'bp-featured-groups' ); ?></option>
                    <option value="fade" <?php selected( $slide_mode, 'fade' )?>><?php _e( 'Fade', 'bp-featured-groups' ); ?></option>
                </select>
            </label>
        </p>
        ...
        <p>
            <label>
				<?php _e( 'Slide speed:', 'bp-featured-groups' ); ?>
        ...
        <p>
            <label>
				<?php _e( 'Slide auto:', 'bp-featured-groups' ); ?>
                <select id="<?php echo $this->get_field_id( 'slide_auto' ); ?>" name="<?php echo $this->get_field_name( 'slide_auto' ); ?>">
                    <option value="1" <?php selected( $slide_auto, 1 )?>><?php _e( 'True', 'bp-featured-groups' ) ?></option>
                    <option value="0" <?php selected( $slide_auto, 0 )?>><?php _e( 'False', 'bp-featured-groups' ) ?></option>
                </select>
            </label>
        </p>
        ...
        <p>
            <label>
	            <?php _e( 'Slide pause Hover:', 'bp-featured-groups' ); ?>
                <select id="<?php echo $this->get_field_id( 'slide_pauseOnHover' ); ?>" name="<?php echo $this->get_field_name( 'slide_pauseOnHover' ); ?>">
                    <option value="1" <?php selected( $slide_pause_on_hover, 1 )?>><?php _e( 'True', 'bp-featured-groups' ) ?></option>
                    <option value="0" <?php selected( $slide_pause_on_hover, 0 )?>><?php _e( 'False', 'bp-featured-groups' ) ?></option>
                </select>
            </label>
        </p>
        ...
        <p>
            <label>
		        <?php _e( 'Slide controls:', 'bp-featured-groups' ); ?>
                <select id="<?php echo $this->get_field_id( 'slide_controls' ); ?>" name="<?php echo $this->get_field_name( 'slide_controls' ); ?>">
                    <option value="1" <?php selected( $slide_controls, 1 )?>><?php _e( 'True', 'bp-featured-groups' ) ?></option>
                    <option value="0" <?php selected( $slide_controls, 0 )?>><?php _e( 'False', 'bp-featured-groups' ) ?></option>
                </select>
            </label>
        </p>
        ...
        <p>
            <label>
				<?php _e( 'Slide loop:', 'bp-featured-groups' ); ?>
                <select id="<?php echo $this->get_field_id( 'slide_loop' ); ?>" name="<?php echo $this->get_field_name( 'slide_loop' ); ?>">
                    <option value="1" <?php selected( $slide_loop, 1 )?>><?php _e( 'True', 'bp-featured-groups' ) ?></option>
                    <option value="0" <?php selected( $slide_loop, 0 )?>><?php _e( 'False', 'bp-featured-groups' ) ?></option>
                </select>
            </label>
        </p>
</div>
