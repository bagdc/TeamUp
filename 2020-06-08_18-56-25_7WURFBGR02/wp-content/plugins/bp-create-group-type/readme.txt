...
= 2.3.0 =
* Fix - Revert back "Remove Display Directory view link"
* Fix - Fixed Plugin settings page link with Multisite
* Fix - Display BuddyPress Group post type shortcode meta box only on Group Type
