			...
			<div class="notice updated bp-add-group-types-notice">
				<div class="bp-add-group-types-notice-inner">
					<div class="bp-add-group-types-notice-icon">
						<img src="<?php echo BP_GROUP_TYPE_PLUGIN_URL . 'admin/wbcom/assets/imgs/group-type.png'; ?>" alt="<?php echo esc_attr__( 'BuddyPress Create Group Types', 'bp-add-group-types' ); ?>" />
					</div>
