		...
		<div class="item-body" id="group-create-body">
			...
			<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
				...
				<div>
					...
					<label for="group-desc"> <small> Compilare i campi necessari o modificarli a proprio piacimento. </small></label>
					<textarea name="group-desc" id="group-desc" aria-required="true">
Descrizione: 
Numero di partecipanti: 
Posizioni Richieste: 
Data inizio progetto: 
Data prevista fine: 
						<?php bp_new_group_description(); ?></textarea>
				</div>
			...
			<?php if ( bp_is_group_creation_step( 'group-settings' ) ) : ?>
				...
				<fieldset class="group-create-privacy">
					...
					<div class="radio">
						...
						<label for="group-status-private"><input type="radio" name="group-status" id="group-status-private" value="private"<?php { ?> checked="checked"<?php } ?> aria-describedby="private-group-description"  /> <?php _e( 'This is a private group', 'buddypress' ); ?></label>
